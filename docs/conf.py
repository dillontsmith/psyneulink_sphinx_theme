...
sys.path.insert(0, os.path.abspath('/Users/ds70/PycharmProjects/PsyNeuLink'))
# adding this path alone so that Run/Environment module can go in the dropdown underneath Scheduling
sys.path.insert(0, os.path.abspath('/Users/ds70/PycharmProjects/PsyNeuLink/psyneulink/globals/'))
